...
[Changelog](https://github.com/tigerbeetle-rust/tigerbeetle-unofficial/blob/v0.14.0%2B0.16.50/CHANGELOG.md)
...
> ```toml
> [dependencies]
> tigerbeetle-unofficial = "=0.14.0+0.16.50"
> ```
...
`tigerbeetle-unofficial` crates are licensed under the [Apache License, Version 2.0](https://github.com/tigerbeetle-rust/tigerbeetle-unofficial/blob/v0.14.0%2B0.16.50/LICENSE) (the "License"); you may not use these files except in compliance with the License. You may obtain a copy of the License at
