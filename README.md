...
[Changelog](https://github.com/tigerbeetle-rust/tigerbeetle-unofficial/blob/v0.9.3%2B0.16.32/CHANGELOG.md)
...
`tigerbeetle-unofficial` crates are licensed under the [Apache License, Version 2.0](https://github.com/tigerbeetle-rust/tigerbeetle-unofficial/blob/v0.9.3%2B0.16.32/LICENSE) (the "License"); you may not use these files except in compliance with the License. You may obtain a copy of the License at
