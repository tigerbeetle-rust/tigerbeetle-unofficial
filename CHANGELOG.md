...
## [0.12.4+0.16.47] · 2025-07-01
[0.12.4+0.16.47]: https://github.com/tigerbeetle-rust/tigerbeetle-unofficial/tree/v0.12.4%2B0.16.47

[Diff](https://github.com/tigerbeetle-rust/tigerbeetle-unofficial/compare/v0.12.3%2B0.16.46...v0.12.4%2B0.16.47) | [Milestone](https://github.com/tigerbeetle-rust/tigerbeetle-unofficial/milestone/31)

### Changed

- Upgraded [`tb_client` C library] to [0.16.47 version][tb-0.16.47]. ([#75])
- `sys` crate:
    - Size of `opaque` field in `tb_packet_t` struct from 32 to 64 bytes. ([#75], [tigerbeetle/tigerbeetle#3038])
